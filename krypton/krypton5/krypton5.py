...
def main():
    ...
    for i in range(len(ciphertext1)):
        if i % keylen == pos:
            current_letter = ciphertext1[i]
            if current_letter in letters_count:
    ...
    for i in range(len(ciphertext3)):
        if i % keylen == pos:
            current_letter = ciphertext3[i]
            if current_letter in letters_count:
                letters_count[current_letter] += 1
            else:
                letters_count[current_letter] = 1
    ...
    print('Statistics:')
    for c in sorted(letters_count.keys()):
        print(f'{c} - {letters_count[c] / total_count * 100:.2f}%')
